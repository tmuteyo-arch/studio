...
import { ArrowLeft, Check, FileText, History, User, X } from 'lucide-react';
...
export default function ApplicationReview({ application, onBack, showActions = false }: ApplicationReviewProps) {
  return (
    <div>
