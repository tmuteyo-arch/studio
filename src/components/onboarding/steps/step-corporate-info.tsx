      ...
      <div className="px-6">
        <Accordion type="multiple" defaultValue={['item-1', 'item-2', 'item-3', 'item-4']} className="w-full">
            ...
            <AccordionContent className="p-1">
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <FormField control={form.control} name="socials.facebook" render={({ field }) => ( <FormItem> <FormLabel>Facebook</FormLabel> <FormControl><Input placeholder="facebook.com/acme" {...field} value={field.value ?? ''} /></FormControl> </FormItem> )}/>
                  <FormField control={form.control} name="socials.twitter" render={({ field }) => ( <FormItem> <FormLabel>Twitter</FormLabel> <FormControl><Input placeholder="twitter.com/acme" {...field} value={field.value ?? ''} /></FormControl> </FormItem> )}/>
                  <FormField control={form.control} name="socials.skype" render={({ field }) => ( <FormItem> <FormLabel>Skype</FormLabel> <FormControl><Input placeholder="acme_skype" {...field} value={field.value ?? ''} /></FormControl> </FormItem> )}/>
                   <FormField control={form.control} name="socials.linkedin" render={({ field }) => ( <FormItem> <FormLabel>LinkedIn</FormLabel> <FormControl><Input placeholder="linkedin.com/company/acme" {...field} value={field.value ?? ''} /></FormControl> </FormItem> )}/>
                   <FormField control={form.control} name="socials.other" render={({ field }) => ( <FormItem> <FormLabel>Other</FormLabel> <FormControl><Input placeholder="Social media link" {...field} value={field.value ?? ''} /></FormControl> </FormItem> )}/>
                </div>
                <Separator />
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              <h3 className="font-semibold text-lg">Account Specifications</h3>
            </AccordionTrigger>
            <AccordionContent className="p-1">
              <div className="space-y-4 pt-2">
                 <FormItem>
                    <FormLabel>Account Currency</FormLabel>
                     <div className="grid grid-cols-3 md:grid-cols-5 gap-4 pt-2">
                        <FormField control={form.control} name="accountCurrency.usd" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">USD</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountCurrency.zar" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">ZAR</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountCurrency.gbp" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">GBP</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountCurrency.eur" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">EUR</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountCurrency.bwp" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">BWP</FormLabel> </FormItem> )}/>
                     </div>
                </FormItem>
                 <Separator/>
                 <FormField
                ...
                <Separator />
                <FormItem>
                    <FormLabel>Account Type (Tick applicable)</FormLabel>
                     <div className="grid grid-cols-3 md:grid-cols-5 gap-4 pt-2">
                        <FormField control={form.control} name="accountTypeTick.transactional" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">Transactional</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountTypeTick.savings" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">Savings</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountTypeTick.termDeposit" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">Term Deposit</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountTypeTick.mMarket" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">M Market</FormLabel> </FormItem> )}/>
                        <FormField control={form.control} name="accountTypeTick.loan" render={({ field }) => ( <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4"> <FormControl><Checkbox checked={field.value} onCheckedChange={field.onChange} /></FormControl> <FormLabel className="font-normal">Loan</FormLabel> </FormItem> )}/>
                     </div>
                </FormItem>
              </div>
            </AccordionContent>
           ...
           <AccordionItem value="item-3">
            ...
            <AccordionContent className="p-1">
               <div className="space-y-4 pt-2">
                ...
                <Separator/>
                 <FormItem>
                    <FormLabel>If you wish to have some of these services, please indicate below. A separate form maybe required.</FormLabel>
